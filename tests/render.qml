...
ShellRoot {
    ...
    property var shots: ["cards", "edit", "motion", "question", "empty", "narrow", "scaled", "light", "dark", "pane-edit"]
    ...
    Timer {
        ...
        onTriggered: {
            ...
            area.grabToImage(function(result) {
                ...
                if (next === "question") service.question = {id: 1, mode: "select", prompt: "Choose a second app", choices: [{value: "a", label: "WhatsApp", detail: "Workspace 2"}, {value: "b", label: "Telegram", detail: "Workspace 2"}, {value: "w", label: "Add from workspace 5", detail: "Move an app here"}]}
